...
DB_NAME=todo
DB_URL=postgresql://todo:todo@localhost:5432/$(DB_NAME)?sslmode=disable

postgres:
	docker run --name $(DOCKER_CONTAINER_NAME) -p 5432:5432 -e POSTGRES_USER=todo -e POSTGRES_PASSWORD=todo -d postgres:14.4-alpine
